...
const BaelEx = () => {
  ...
  return (
    <div className='ex'>
       ...
       <section>
       <h3>Benefits of Bael Tree:</h3>
        <br />
        <ul>
            <li>It has excellent benefits for various medicinal purposes. </li>
            <li></li>
            <li>This medical tree has fragrant flowers to maintain a soothing aura around it. </li>
            <li></li>
            <li>Bael tree has nutrients, vitamins, protein, and many more healthy qualities</li>
