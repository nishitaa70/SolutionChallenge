...
const ArjunaEx = () => {
  return (
   ...
   <section>
   <h3>Benefits of Arjuna Tree :</h3>
    <br />
    <ul>
    <li>It acts as an antioxidant, antimicrobial, anti-inflammatory. </li>
	<li></li>
	<li> The tree reduces the risk of heart-related difficulties.</li>
	<li></li>
